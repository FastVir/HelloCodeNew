// Вид 1 - Методы которые не принмают значения и не ничего не возвращают (методы ничего не возвращающие, но при этом принимающие либо не принимающие значения называются void)
// void Method1()
// {
